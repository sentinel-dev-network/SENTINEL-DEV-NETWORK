...
End-user applications — installable, zero-setup, local-first.

| App | What it does | Use it |
|---|---|---|
| [pocketbudget](https://github.com/sentinel-dev-network/pocketbudget) | Offline envelope budgeting PWA — no account, no bank link, no cloud; data never leaves your device | [open app](https://sentinel-dev-network.github.io/pocketbudget/) |
